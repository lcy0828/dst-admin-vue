...
function applyThemeVariables(themeValue) {
  ...
  const variables = {
    ...
    '--sidebar-active-bg': mix(preset.sidebarActive, preset.sidebar, 0.82),
    '--shadow-card': `0 1px 3px rgba(${shadowRgb}, 0.08)`,
    '--shadow-card-hover': `0 6px 18px rgba(${shadowRgb}, 0.11)`,
