  ...
  'zh-CN': {
    ...
    dashboard: {
      ...
      resources: {
        title: '系统资源',
        refresh: '刷新系统资源',
        systemRefreshInterval: '系统资源自动刷新',
        systemRefreshIntervalAria: '系统资源自动刷新间隔：{value}',
        roomRefreshInterval: '房间与世界自动刷新',
        roomRefreshIntervalAria: '房间与世界自动刷新间隔：{value}',
        ...
        singleCore: '单核峰值',
        cpuAverage: 'CPU 平均',
        busiestCoreSummary: '单核峰值：核心 {index} · {usage}',
        highCoreWarning: '逻辑核心 {index} 已超过 80%，当前 {usage}',
        perCore: '各核心使用率',
        logicalCoreCount: '{count} 个逻辑核心',
        coreLabel: '核心 {index}',
        coreUsageAria: '逻辑核心 {index} 使用率',
        memory: '内存',
        used: '已用 {used} / {total}',
        disk: '磁盘',
        free: '空闲 {free} / {total}',
      ...
      version: {
        ...
        simpleTitle: '游戏更新',
        simpleDescription: '检查游戏是否有新版本，并在可用时一键更新。',
        check: '检查游戏版本',
        loadFailed: '版本读取失败',
        officialGame: '官方游戏版本',
        ...
        updateAvailable: '可更新',
        upToDate: '已最新',
        installRequired: '尚未安装游戏服务端',
        updateStateUnknown: '状态未知',
        upToDateDescription: '当前游戏服务端已是最新版本。',
        updateAvailableDescription: '发现新版本，可以直接备份并更新。',
        externalUpdateDescription: '发现新版本，但当前安装由 Steam 客户端管理，请先在 Steam 中更新。',
        installRequiredDescription: '安装完成后即可创建并启动森林、洞穴等世界。',
        updateStateUnknownDescription: '暂时无法确认是否有新版本，请重新检查。',
        openUpdateHelp: '查看更新方式',
        checkedAt: '检查于 {time}',
        ...
        installReady: '可以安装游戏服务端',
        installReadyDescription: '安装完成后即可创建并启动森林、洞穴等世界。文件会保存在当前配置的服务端目录。',
        updateCompleted: '更新已完成',
        installing: '正在安装游戏服务端',
        updating: '正在更新',
        waiting: '等待更新',
        installButtonBusy: '安装中',
        installButton: '安装游戏服务端',
      ...
      feedback: {
        ...
        cleanupSucceededRefreshFailed: '失败会话已清理，但最新状态读取失败，当前继续显示上次数据',
        cleanupFailed: '清理失败：{error}',
        updateStatusFailed: '获取更新状态失败',
        installConfirm: '确定要安装饥荒联机版专用服务器吗？下载时间取决于当前网络。',
        installConfirmTitle: '安装游戏服务端',
        installConfirmButton: '开始安装',
  ...
  'en-US': {
    ...
    dashboard: {
      ...
      resources: {
        ...
        systemRefreshInterval: 'System resource auto-refresh',
        systemRefreshIntervalAria: 'System resource auto-refresh interval: {value}',
        roomRefreshInterval: 'Room and world auto-refresh',
        roomRefreshIntervalAria: 'Room and world auto-refresh interval: {value}',
        ...
        singleCore: 'Peak core',
        cpuAverage: 'CPU average',
        busiestCoreSummary: 'Peak core: CPU {index} · {usage}',
        highCoreWarning: 'Logical CPU {index} is above 80% at {usage}',
        perCore: 'Per-core usage',
        logicalCoreCount: '{count} logical CPUs',
        coreLabel: 'CPU {index}',
        coreUsageAria: 'Logical CPU {index} usage',
        memory: 'Memory',
      ...
      version: {
        ...
        simpleTitle: 'Game update',
        simpleDescription: 'Check for a new game version and update it in one step when supported.',
        ...
        upToDate: 'Up to date',
        installRequired: 'Game server not installed',
        updateStateUnknown: 'Status unknown',
        upToDateDescription: 'The game server is on the latest version.',
        updateAvailableDescription: 'A new version is available and can be backed up and updated now.',
        externalUpdateDescription: 'A new version is available, but Steam manages this installation. Update it in Steam first.',
        installRequiredDescription: 'Install the server before creating and starting Forest, Caves, or other worlds.',
        updateStateUnknownDescription: 'The latest version cannot be confirmed right now. Check again.',
        openUpdateHelp: 'View update method',
        ...
        installReady: 'Game server ready to install',
        installReadyDescription: 'After installation, you can create and start Forest, Caves, and other worlds. Files are stored in the configured server directory.',
        updateCompleted: 'Update complete',
        installing: 'Installing the game server',
        updating: 'Updating',
        waiting: 'Waiting to update',
        installButtonBusy: 'Installing',
        installButton: 'Install game server',
      ...
      feedback: {
        ...
        cleanupSucceededRefreshFailed: 'The failed session was cleaned up, but the latest state could not be loaded. The previous data remains visible.',
        cleanupFailed: 'Cleanup failed: {error}',
        updateStatusFailed: 'Failed to get update status',
        installConfirm: "Install the Don't Starve Together dedicated server? Download time depends on the current network.",
        installConfirmTitle: 'Install game server',
        installConfirmButton: 'Install',
        installSubmitted: 'Installation job submitted',
